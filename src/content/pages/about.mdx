...
<Icon sprite={GrumpyCorpName} className="h075" /> is the name of my movie studio / consulting company / record label / construction outfit, whatever it ends up being.
...
- ~~Figure out whether food could be a livelihood~~
  - Figure out how to help with a restaurant
    ...
    - ~~dishwashing~~
    - ~~cooking (I'm a licensed Washington State food worker)~~ been there, done it, doesn't pay
