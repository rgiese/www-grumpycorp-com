...
1. Here's how technology could help! -- _it's just where my brain goes first. sigh._
1. But technology so often just makes things worse. -- _ugh, but true._
...
- Invest the time to not only understand the right solution but also its implications: moral/ethical, not just economical or technical.
...
As a shorthand, let's call this your _culture_.
...
You may well have come across ideas that are technically or economically sound, but perhaps not morally/ethically. What happens then?
...
Bonus points for conversations about psychological safety and agency.
