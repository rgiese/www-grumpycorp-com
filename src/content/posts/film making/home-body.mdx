...
and we were really happy and surprised to learn that we won some awards among a pool of sixteen submissions:
...
Here's how it went down. (Note: contains spoilers.)
...
The writer's room starts. The clock is ticking - the film must checksum and begin uploading by 7:30pm on Sunday, just over 48 hours away.
...
her in. (We've never greenscreened anything before.)
...
Each location gets its shot pages stapled together into packets so I didn't need to lug the entire thing around all day long.
...
We film the bathroom scene where a ghost appears in the window (first seen through the mirror, then whip-panned over and back again).
